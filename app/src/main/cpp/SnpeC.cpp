...
SnpeC::SnpeC(std::string &dlc, int system_type, std::vector<std::string> &output_layers) {
...
/************************************************************************
* Name : obj_predict
* Function: Method of SnpeC class for infrencing
* Returns: A STL map with output tensor as key and its corresponding
*          output as value of map.
************************************************************************/
std::map<std::string, std::vector<float>> SnpeC::obj_predict(cv::Mat input_image) {
