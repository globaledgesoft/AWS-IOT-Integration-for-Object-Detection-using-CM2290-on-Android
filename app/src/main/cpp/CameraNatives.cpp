...
CameraNatives::CameraNatives(camera_type type) {
...
bool CameraNatives::MatchCaptureSizeRequest(ImageFormat* resView, int32_t width, int32_t height) {
...
bool CameraNatives::CreateCaptureSession(ANativeWindow* window) {
